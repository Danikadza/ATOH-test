...
class QuerySession extends events_1.default {
    ...
    async delete() {
        ...
        await this[exports.attachStream]?.cancel();
    ...
    //     return this.delete();
    // }
    [symbols.sessionAttach] = query_session_attach_1.attach;
    ...
    [symbols.sessionBeginTransaction] = query_session_transaction_1.beginTransaction;
    [symbols.sessionCommitTransaction] = query_session_transaction_1.commitTransaction;
    [symbols.sessionRollbackTransaction] = query_session_transaction_1.rollbackTransaction;
