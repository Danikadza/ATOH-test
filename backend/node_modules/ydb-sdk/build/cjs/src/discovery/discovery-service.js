...
const authenticated_service_1 = require("../utils/authenticated-service");
const with_timeout_1 = require("../utils/with-timeout");
const noOp = () => {
};
class DiscoveryService extends authenticated_service_1.AuthenticatedService {
    ...
    ready(timeout) {
        return (0, with_timeout_1.withTimeout)(this.endpointsPromise, timeout);
    }
    async getEndpointRR() {
        await this.endpointsPromise;
