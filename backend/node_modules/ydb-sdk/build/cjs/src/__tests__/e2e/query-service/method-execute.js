...
describe('Query.execute()', () => {
    ...
    async function insertCupleLinesInTestTable() {
        await session.execute({
            parameters: {
                ...
                '$timestamp': types_1.TypedValues.timestamp(new Date()),
            },
            text: `
    ...
    async function testOnOneSessionWithoutDriver() {
        ...
        const sessionBuilder = new query_session_pool_1.SessionBuilder(await discoveryService.getEndpoint(), DATABASE, authService, logger);
